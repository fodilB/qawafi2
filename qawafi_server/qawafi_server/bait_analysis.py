...
class BaitAnalysis:
    def __init__(self, use_cbhg=True, Arabic_Diacritization=None):
        ...
        if self.use_cbhg:
            ...
            try:
                from qawafi_server.Arabic_Diacritization.poetry_diacritizer.predict import DiacritizationTester

                self.diac_model = DiacritizationTester(
                    "qawafi_server/Arabic_Diacritization/poetry_diacritizer/config/test.yml", "cbhg", "../Arabic_Diacritization/model/CA_MSA.base.cbhg/models/175000-snapshot.pt"
                )
